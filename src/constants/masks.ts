export const MASK_OPTIONS = [
  ...
  { label: '254.0.0.0 (/7)', value: '254.0.0.0' },
  { label: '252.0.0.0 (/6)', value: '252.0.0.0' },
  { label: '248.0.0.0 (/5)', value: '248.0.0.0' },
  { label: '240.0.0.0 (/4)', value: '240.0.0.0' },
  { label: '224.0.0.0 (/3)', value: '224.0.0.0' },
  { label: '192.0.0.0 (/2)', value: '192.0.0.0' },
  { label: '128.0.0.0 (/1)', value: '128.0.0.0' },
